...
namespace EEM4QC_HFT_2021221.Data
{
    public class DataContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {//D:\EEM4QC_HFT_2022_js_and_wpf-master\EEM4QC_HFT_2022_js_and_wpf-master\EEM4QC_HFT_2021221.Data
             //optionsBuilder.UseSqlServer(@"Server = .;AttachDbFilename=|DataDirectory|\Database1.mdf;Trusted_Connection = True;");
             //optionsBuilder.UseSqlServer(@"Data Source=.;User ID=sa;Initial Catalog=Database; Password=numan123;");
             //optionsBuilder.UseSqlServer(@"Server = .;Initial Catalog=D:\EEM4QC_HFT_2022_js_and_wpf-master\EEM4QC_HFT_2022_js_and_wpf-master\EEM4QC_HFT_2021221.Data\Database1.mdf;Trusted_Connection = True;TrustServerCertificate=False");
                optionsBuilder.UseSqlServer(@"Server = (LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\Database1.mdf;Trusted_Connection = True;");
            }
